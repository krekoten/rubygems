...
Bugfixes:
  ...
  - Fix multiplatform resolution edge cases [#7522](https://github.com/rubygems/bundler/pull/7522), [#7554](https://github.com/rubygems/bundler/pull/7554) and [#7578](https://github.com/rubygems/bundler/pull/7578). TODO: [#7554](https://github.com/rubygems/bundler/pull/7554) WILL MOST LIKELY BE REVERTED BEFORE RELEASE, since it was fixed at the `compact_index` gem and thus correctly formatted data will be coming from the server
